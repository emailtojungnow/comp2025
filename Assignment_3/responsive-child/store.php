...
<?php if(isset($_POST[$postName]) && !empty($_POST[$postName])): ?>
   <?php persist_option($optionName, $_POST); ?> 
   <script> 
      alert("Thanks for submitting your data!");
      location.href = ("<?php $url = home_url('/user-data'); echo $url;?>"); // change '/user-data' location as required. It should point the result display page's permalink. 
   </script>
<?php endif; ?>
